...
class GeneralExchangeFactory(IExchangeFactory):
    ...
    def get_exchange_wrapper(self, exchange_name):
        """
        Returns an initialized instance of the exchange wrapper class by the name of exchange_name.

        It an initialized instance of the exchange wrapper class by the name of exchange_name. 
        ...
        Returns:
            If exchange_name found in _initialized_exchange_wrappers it returns IExchangeWrapper, otherwise None.
