"""
    ...
    It will decrypt the YAML config file and provides other
     classes with their configurations.
...
class Config:
    ...
    It will decrypt the YAML config file and provides other classes
    ...
    Methods:
        get_property(cls, property_name): Returns the value
         of requested property_name.

        decrypt_configuration(cls): Decrypt configuration file
         and set class CONFIGURATION member.
    ...
    def obtain_configuration(cls):
        ...
        It assumes an environment variable CRYPTO_SUMMONER_CONFIG_FILE
         is set to YAML configuration file.
